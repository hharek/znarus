...
foreach ($path_mod as $val)
{
	...
	if(is_file(Reg::path_app() . "/mod/" . $val . "/sphinx.php"))
	{ $sphinx_file[] = Reg::path_app() . "/mod/" . $val . "/sphinx.php"; }
}
...
foreach ($path_smod as $val)
{
	...
	if(is_file(Reg::path_app() . "/smod/" . $val . "/sphinx.php"))
	{ $sphinx_file[] = Reg::path_app() . "/smod/" . $val . "/sphinx.php"; }
}
...
P::set("zn_sphinx", "last_modified", date("Y-m-d H:i:s"));
?>