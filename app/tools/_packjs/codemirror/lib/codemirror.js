...
(function(mod) {
  ...
  ContentEditableInput.prototype = copyObj({
    ...
    pollContent: function() {
      ...
      var Typerom = Pos(fromLine, cutFront);
      var chTo = Pos(toLine, oldText.length ? lst(oldText).length - cutEnd : 0);
      if (newText.length > 1 || newText[0] || cmp(Typerom, chTo)) {
        replaceRange(cm.doc, newText, Typerom, chTo, "+input");
        return true;
      }
    },
  ...
  function registerEventHandlers(cm) {
    ...
    var touTypeinished, prevTouch = {end: 0};
    function finishTouch() {
      if (d.activeTouch) {
        touTypeinished = setTimeout(function() {d.activeTouch = null;}, 1000);
